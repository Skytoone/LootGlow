...
[![Plugin Version](https://img.shields.io/badge/Version-1.6.3--beta4-FFD700?style=for-the-badge&logo=minecraft)](https://www.spigotmc.org/resources/134648)
...
dependencies {
    compileOnly 'com.github.Skytoone.LootGlow:LootGlow-API:v1.6.3-beta4'
}
```
...
The compiled plugin JAR will be available at `target/LootGlow-1.6.3-beta3.jar`.
